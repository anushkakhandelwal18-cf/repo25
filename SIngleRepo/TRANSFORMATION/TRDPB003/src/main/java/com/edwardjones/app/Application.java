...
/**
* The Trdpb002 application can be started in three different ways
* 1. Via mainframe JCL
...
Trdpb002 trdpb002 = (Trdpb002) context.getBean("trdpb002");
...
trdpb002.setParameter(new GlobalExecutorCtx().getContext(Trdpb002Ctx.class),inputValue);
